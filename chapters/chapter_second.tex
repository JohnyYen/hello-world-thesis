...
\hlinegallego\_panoramica\_nodate, barban\_entrenaingeniero\_2020\}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=1\textwidth, max height=1\textheight, keepaspectratio}{
        \includegraphics{src/C4_Components_API}
    }
    \caption{Diagrama de Componentes del API Backend.}
    \label{fig:c4_backend}
\end{figure}
