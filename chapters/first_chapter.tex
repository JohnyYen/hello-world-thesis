...
Una clasificación más precisa y ampliamente utilizada es aquella que se basa en el \textit{gameplay} o estilo de juego. La revisión de la literatura realizada por \textcite{herrero_taxonomivideojuegos_2015} establece un resumen de los principales géneros generales en los videojuegos:
...
\section{Análisis de plataformas educativas}
...
Diversos estudios coinciden en que el uso de Kahoot! genera beneficios pedagógicos significativos, especialmente en términos de motivación y compromiso. La plataforma favorece la motivación intrínseca del alumnado, incrementa la satisfacción durante el proceso de aprendizaje y contribuye a una mayor asistencia a clase. Asimismo, fomenta un enfoque de aprendizaje activo y centrado en el estudiante, permitiendo reforzar contenidos teóricos y prácticos de manera dinámica y participativa, especialmente cuando se utiliza como actividad posterior a una lección tradicional \cite{singh2024exploring}.

En el ámbito del monitoreo y la evaluación formativa, Kahoot! destaca por su capacidad de proporcionar retroalimentación inmediata tanto al docente como al estudiante. Los resultados obtenidos en tiempo real permiten identificar rápidamente errores conceptuales, lagunas de conocimiento o dificultades generalizadas dentro del grupo. Además, la visualización de puntajes finales facilita la autoevaluación del alumnado, promoviendo la reflexión sobre su propio proceso de aprendizaje y favoreciendo una transición hacia modelos educativos más centrados en el estudiante \cite{singh2024exploring}.

No obstante, la literatura también señala ciertos desafíos asociados al uso de Kahoot!. Entre los principales problemas se encuentran las barreras técnicas relacionadas con la conectividad a Internet, cuya inestabilidad puede generar frustración y limitar la participación. Asimismo, algunos autores advierten que un énfasis excesivo en la competencia y en las recompensas extrínsecas puede derivar en un compromiso superficial, desplazando el foco del aprendizaje profundo hacia la simple obtención de puntos. De igual forma, la dinámica competitiva puede generar ansiedad en determinados estudiantes, afectando negativamente su experiencia de aprendizaje \cite{singh2024exploring}.

A pesar de estas limitaciones, el impacto y alcance de Kahoot! en el ámbito educativo es notable. Con más de 20 millones de usuarios a nivel mundial, la plataforma ha demostrado ser versátil y efectiva en distintos niveles educativos, desde educación inicial hasta educación superior, así como en áreas específicas como la enseñanza de segundas lenguas, donde se ha observado una mejora en la retención de vocabulario. Estos resultados consolidan a Kahoot! como una referencia relevante dentro del estado del arte en gamificación educativa \cite{singh2024exploring}.
...
Uno de los pilares fundamentales del Método Duolingo es el principio de \textit{aprender haciendo} (\textit{learn by doing}), que promueve la interacción directa del estudiante con el contenido desde el inicio, sin recurrir a explicaciones teóricas extensas. Este enfoque se apoya en mecanismos de aprendizaje estadístico implícito, mediante los cuales el cerebro identifica patrones a partir de la exposición repetida a estructuras cuidadosamente seleccionadas. Asimismo, se emplea el razonamiento analógico para facilitar la internalización de reglas y patrones, junto con estrategias de cognición corporizada, que integran la percepción física y la acción motora —como trazar letras o manipular objetos virtuales— en la construcción de conceptos abstractos \cite{freeman2023duolingo}.

La personalización del aprendizaje constituye otro eje central de la plataforma, sustentado en el uso de inteligencia artificial. Duolingo emplea el modelo de aprendizaje automático conocido como \textit{Birdbrain}, el cual analiza diariamente un volumen masivo de interacciones para estimar el nivel de competencia del usuario y ajustar con precisión la dificultad de cada ejercicio. Este sistema aplica el concepto de zona de desarrollo próximo, ofreciendo retos que resultan estimulantes sin generar frustración, e integra técnicas de repetición espaciada para reforzar la retención a largo plazo del conocimiento adquirido \cite{freeman2023duolingo}.

En cuanto al contenido, los currículos de Duolingo se encuentran alineados con estándares educativos internacionales, garantizando la adquisición de habilidades relevantes para contextos reales. En el ámbito de los idiomas, la plataforma sigue el Marco Común Europeo de Referencia para las Lenguas (CEFR), priorizando objetivos comunicativos funcionales. Por su parte, los programas de alfabetización y matemáticas se basan en los \textit{Common Core State Standards} de los Estados Unidos, lo que asegura coherencia y rigor pedagógico en estas áreas \cite{freeman2023duolingo}.

La motivación y la constancia del alumnado se refuerzan mediante un sistema de gamificación cuidadosamente diseñado. Las lecciones de corta duración reducen la carga cognitiva y aumentan la percepción de progreso, mientras que mecanismos como las rachas de uso diario, las notificaciones y las tablas de clasificación fomentan la formación de hábitos de aprendizaje sostenidos. Este componente social y competitivo, gestionado de forma equilibrada, contribuye a mantener altos niveles de participación y compromiso \cite{freeman2023duolingo}.

Finalmente, Duolingo incorpora principios de diseño emocional orientados a crear un entorno de aprendizaje positivo y de baja ansiedad. El uso de personajes con identidades y estilos diversos, junto con un tono humorístico y tolerante al error, favorece una percepción segura del proceso de aprendizaje. La retroalimentación positiva y las animaciones de celebración refuerzan la confianza del estudiante y consolidan una experiencia educativa atractiva y accesible. Actualmente, este método se materializa en tres aplicaciones principales: la aplicación de idiomas, con más de cuarenta lenguas disponibles, la aplicación de alfabetización orientada a la lectura temprana y la aplicación de matemáticas, centrada en el aprendizaje de contenidos elementales y el entrenamiento cognitivo \cite{freeman2023duolingo}.
