...
En el desarrollo de sistemas educativos digitales, la selección del sistema de gestión de bases de datos (SGBD) constituye un componente crítico, ya que impacta directamente en la consistencia de la información, el rendimiento de las consultas y la escalabilidad del sistema. En este proyecto se adopta una arquitectura híbrida que combina bases de datos relacionales y ligeras, utilizando \textbf{PostgreSQL} en el entorno del \textit{backend} y \textbf{SQLite} para el almacenamiento local del videojuego educativo. Esta combinación busca equilibrar robustez, eficiencia y portabilidad, requisitos esenciales en plataformas que integran componentes de escritorio y servicios web.
...
\textbf{PostgreSQL} \cite{postgresql} & SQL relacional & Cumplimiento estricto del modelo ACID; soporte avanzado para transacciones, tipos de datos complejos y extensiones geoespaciales; alta confiabilidad y seguridad. & Mayor consumo de recursos frente a sistemas más ligeros. & Aplicaciones empresariales, sistemas educativos, plataformas web de alto rendimiento. \\
\hline
\textbf{MySQL} \cite{mysql} & SQL relacional & Amplia comunidad y soporte multiplataforma; buen rendimiento en operaciones de lectura; facilidad de configuración. & Limitaciones en el manejo de transacciones complejas; menor flexibilidad frente a PostgreSQL. & Aplicaciones web medianas, sistemas de gestión de contenidos. \\
\hline
...
La combinación de \textbf{PostgreSQL} y \textbf{SQLite} proporciona un equilibrio funcional entre \textbf{rendimiento, portabilidad y consistencia}, optimizando tanto la experiencia local del usuario como la gestión centralizada de los datos. Desde una perspectiva metodológica, esta decisión tecnológica responde al objetivo de asegurar la fiabilidad del almacenamiento, la escalabilidad de la arquitectura y la adaptabilidad de la solución en diversos contextos educativos.
...
A lo largo del capítulo se ha evidenciado que los videojuegos y la gamificación constituyen herramientas educativas con un alto potencial para incrementar la motivación, el compromiso y la participación activa de los estudiantes. Los \textit{serious games} facilitan experiencias inmersivas y significativas, en las que la interactividad, la retroalimentación inmediata y la progresión de niveles favorecen tanto la adquisición de conocimientos como el desarrollo de habilidades cognitivas, sociales y emocionales. La gamificación, al incorporar mecánicas, dinámicas y componentes propios del juego en contextos educativos, fortalece la motivación intrínseca, estimula la autonomía y genera un sentido de logro que potencia la autorregulación del aprendizaje.

El análisis de las principales teorías del aprendizaje, especialmente el constructivismo, el socioconstructivismo y la teoría del flujo, permitió comprender los fundamentos pedagógicos que sustentan la integración de videojuegos y experiencias gamificadas en entornos educativos. Estas corrientes destacan que el aprendizaje se construye activamente mediante la interacción significativa con el contenido, el entorno y los pares, por lo que la incorporación de elementos lúdicos representa una vía efectiva para promover la implicación, la atención sostenida y el aprendizaje significativo. 

La revisión de experiencias y casos de estudio, posibilitó identificar buenas prácticas, beneficios y desafíos asociados a la implementación de videojuegos educativos. Se evidenció que, si bien estas herramientas contribuyen al logro de aprendizajes profundos y al desarrollo de competencias transversales, su efectividad depende de factores como la planificación pedagógica, la preparación docente, la infraestructura tecnológica y la coherencia entre los objetivos educativos y las dinámicas de juego. Asimismo, se detectaron limitaciones comunes en las propuestas actuales, relacionadas con la falta de personalización, la escasa retroalimentación adaptativa y la dificultad para realizar un seguimiento integral del progreso estudiantil.

En síntesis, este análisis teórico y comparativo sienta una base sólida para el desarrollo de una solución tecnológica que responda a las brechas identificadas en el estado del arte. Los fundamentos revisados respaldan la pertinencia de diseñar una plataforma educativa basada en videojuegos adaptativos, orientada a fortalecer la motivación y la autonomía del estudiante, al tiempo que ofrece mecanismos de evaluación y seguimiento más precisos. De esta manera, las conclusiones de este capítulo se articulan directamente con el problema científico y los objetivos de la investigación, sirviendo como sustento conceptual para el diseño y desarrollo de la propuesta presentada en el siguiente capítulo.
