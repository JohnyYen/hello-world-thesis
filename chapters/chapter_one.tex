...
Los resultados más recurrentes señalan \textbf{incrementos significativos en la motivación, el compromiso y el rendimiento académico} \cite{jajaramillo-mediavilla_impact_2024 ortiz-colon_gamificacion_2018, sierra-daza_videojuegos_2024}.  
...
Por ello, se recomienda que la experiencia gamificada mantenga un equilibrio entre \textbf{recompensa, reto y autonomía}, adaptando la dificultad de las tareas al nivel de competencia del estudiante \cite{morales_e-learning_nodate}.

\subsection{Emociones y engagement en la gamificación}

Las emociones desempeñan un papel central en la experiencia de aprendizaje gamificada, actuando como catalizadoras del compromiso y la participación del estudiante \cite{morales_elearning_noda, jaramillo-mediavilla_2024}.  
...
A lo largo del capítulo se ha evidenciado que los videojuegos y la gamificación constituyen herramientas con alto potencial educativo, capaces de incrementar la motivación, el compromiso y el aprendizaje activo de los estudiantes. Los \textit{serious games} y el Aprendizaje Basado en Juegos (ABJ) permiten experiencias inmersivas y significativas, donde la interactividad, la retroalimentación inmediata y la progresión de niveles facilitan la adquisición de conocimientos y el desarrollo de habilidades cognitivas y transversales. Además, se identificó que la gamificación, al incorporar mecánicas, dinámicas y componentes de juego en contextos no lúdicos, fortalece la motivación intrínseca y promueve la autonomía y el sentido de logro del estudiante.

Asimismo, el análisis de teorías del aprendizaje como el constructivismo, el Aprendizaje Basado en Problemas (ABP) y la teoría del flujo, permitió comprender los fundamentos pedagógicos que sustentan la integración de videojuegos y experiencias gamificadas. Estas teorías subrayan que el aprendizaje se construye activamente mediante la interacción significativa con el contenido, el entorno y los pares, destacando la importancia de contextualizar los recursos educativos, favorecer la resolución de problemas y generar experiencias motivadoras y personalizadas que potencien la implicación del estudiante.

Finalmente, la revisión de experiencias y ejemplos de videojuegos educativos, tanto internacionales como locales, permitió identificar buenas prácticas, beneficios y desafíos de su implementación. Se evidenció que, si bien estos recursos aportan aprendizajes profundos y fomentan competencias transversales, su efectividad depende de una planificación pedagógica adecuada, de la formación docente, de la infraestructura tecnológica y de la adaptación de los contenidos al contexto educativo. Este conocimiento proporciona la base teórica necesaria para el diseño, desarrollo e implementación de la plataforma educativa propuesta, asegurando que sus componentes lúdicos y adaptativos contribuyan efectivamente al aprendizaje significativo.
